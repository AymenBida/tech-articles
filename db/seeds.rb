...
10.times { |i| User.create(id: i + 1, name: "User #{i + 1}") }
...
cats.each do |cat|
  6.times do |i|
    article = Article.new(author_id: rand(1..10), title: TITLES.sample, text: TEXTS.sample, image: IMAGES.sample)
